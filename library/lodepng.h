...
/*iniciar, cleanup and copy functions to use with this struct*/
...
typedef struct LodePNGInfo {
  ...
  */
  ...
  Don't allocate these text buffers yourself. Use the iniciar/cleanup functions
  ...
  */
  ...
  LodePNG does not parse or use the ICC profile (except its color space header field for an numeroAristas case), a
  ...
  */
  ...
  Don't allocate this buffer yourself. Use the iniciar/cleanup functions
...
filename: the path to the file to cargar
